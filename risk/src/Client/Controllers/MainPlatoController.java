...
import Server.model.gamesModels.GameStatus;
...
public class MainPlatoController implements Initializable {
    ...
    public void messages(ActionEvent actionEvent) throws IOException {
        URL url = new File("risk\\src\\Client\\graphic\\messages.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root);
        Stage stage = (Stage) username.getScene().getWindow();
        stage.setScene(scene);
    ...
    public void requests(ActionEvent actionEvent) throws IOException {
        URL url = new File("risk\\src\\Client\\graphic\\FriendsRequest.fxml").toURI().toURL();
        Parent register = FXMLLoader.load(url);
        Scene message = new Scene(register);
        Stage window = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
        window.setScene(message);
    ...
    public void friends(ActionEvent actionEvent) throws IOException {
        URL url = new File("risk\\src\\Client\\graphic\\Friends.fxml").toURI().toURL();
        Parent register = FXMLLoader.load(url);
        Scene message = new Scene(register);
        Stage window = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
        window.setScene(message);
    ...
    public void editinformation(ActionEvent actionEvent) throws IOException {
        URL url = new File("risk\\src\\Client\\graphic\\EditInformation.fxml").toURI().toURL();
        Parent register = FXMLLoader.load(url);
        Scene message = new Scene(register);
        Stage window = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
        window.setScene(message);
