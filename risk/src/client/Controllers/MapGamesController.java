...
import server.model.gamesModels.GameStages;
...
public class MapGamesController implements Initializable {
    ...
    public void dice(MouseEvent mouseEvent) throws IOException {
        URL url = new File("risk\\src\\Client\\graphic\\NumberOfDice.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root);
    ...
    public void cards(MouseEvent mouseEvent) throws IOException {
        URL url = new File("risk\\src\\Client\\graphic\\TerritoryCards.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root);
        JFXPanel username = null;
        Stage stage = (Stage) username.getScene().getWindow();
        ...
        try {
            ...
            if (hasGotTheCountry) {
                ...
                if (gameController.isGameFinished(riskGame)) {
                    ...
                    URL url = new File("risk\\src\\Client\\graphic\\VictoryHint.fxml").toURI().toURL();
